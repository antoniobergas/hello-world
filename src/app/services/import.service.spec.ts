...
describe('ImportService', () => {
  ...
  it('should startImport with valid rows returns completed job', () => {
    const job = service.startImport('Test', 'customers', [{ name: 'Alice', email: 'a@a.com' }], 'u1');
  ...
  it('should startImport assigns row numbers to errors', () => {
    const job = service.startImport('Test', 'customers', [{ name: 'Alice' }, { email: 'b@b.com' }], 'u1');
  ...
  it('should startImport with mixed rows correctly counts valid/invalid', () => {
    const job = service.startImport('Mixed', 'customers', [
