...
const INITIAL_ANNOUNCEMENTS: Announcement[] = [
  { id: 'ann1', title: 'System Maintenance', body: 'Scheduled maintenance window on Sunday', type: 'maintenance', targetAudience: 'all', active: true, startAt: past(1), endAt: future(2), createdBy: 'admin' },
  { id: 'ann2', title: 'New Feature: Dark Mode', body: 'Dark mode is now available!', type: 'feature', targetAudience: 'all', active: true, startAt: past(5), createdBy: 'admin' },
  { id: 'ann3', title: 'Security Update Required', body: 'Please rotate your API keys', type: 'warning', targetAudience: 'admins', active: true, startAt: past(2), endAt: future(5), createdBy: 'security-team' },
  { id: 'ann4', title: 'Old Notice', body: 'This notice has expired', type: 'info', targetAudience: 'all', active: false, startAt: past(30), endAt: past(10), createdBy: 'admin' },
  { id: 'ann5', title: 'Tenant Specific Notice', body: 'Something specific to t1', type: 'info', targetAudience: 't1', active: true, startAt: past(1), createdBy: 'admin' },
  { id: 'ann6', title: 'Beta Features Available', body: 'Opt in to beta features', type: 'feature', targetAudience: 'admins', active: true, startAt: past(3), createdBy: 'product-team' },
  { id: 'ann7', title: 'Upcoming Price Change', body: 'Prices change next quarter', type: 'warning', targetAudience: 'all', active: false, startAt: future(10), createdBy: 'billing-team' },
  { id: 'ann8', title: 'Platform Status Update', body: 'All systems operational', type: 'info', targetAudience: 'all', active: true, startAt: past(0), createdBy: 'ops-team' },
];
