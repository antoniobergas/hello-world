...
describe('ApiKeyService', () => {
  ...
  it('should initialize with 6 seed keys', () => {
    expect(service.keys.length).toBe(6);
  });
  ...
  it('should generated key stores permissions', () => {
    const k = service.generate('My Key', 't1', 'u1', ['read', 'write']);
    expect(k.permissions).toEqual(['read', 'write']);
  });
  ...
  it('should getLastUsed returns date for key with usage', () => {
