...
const INITIAL_WORKSPACES: Workspace[] = [
  ...
  },
  {
    ...
    settings: { allowGuestAccess: true, defaultRole: 'viewer', features: ['campaigns'] },
    archived: false,
  },
  {
    id: 'ws3',
    ...
    settings: { allowGuestAccess: false, defaultRole: 'editor', features: ['crm'] },
    archived: false,
  },
  {
    id: 'ws4',
    ...
    settings: { allowGuestAccess: false, defaultRole: 'viewer', features: ['ticketing'] },
    archived: false,
  },
  {
    id: 'ws5',
  ...
  },
  {
    ...
    tenantId: 't1',
    ownerId: 'u14',
    memberIds: ['u14', 'u15', 'u1'],
    createdAt: new Date('2023-04-01'),
    settings: { allowGuestAccess: false, defaultRole: 'editor', features: ['roadmap', 'specs'] },
    archived: false,
  },
  {
    id: 'ws7',
  ...
  },
  {
    ...
    name: 'Legacy Project',
    slug: 'legacy-project',
    description: 'Archived legacy project',
    tenantId: 't1',
    ownerId: 'u1',
    memberIds: ['u1'],
