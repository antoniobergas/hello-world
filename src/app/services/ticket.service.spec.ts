...
describe('TicketService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({ providers: [TicketService] });
    service = TestBed.inject(TicketService);
  });

  it('should be created', () => { expect(service).toBeTruthy(); });
  it('should initialize with 25 seed tickets', () => { expect(service.tickets.length).toBe(25); });
  ...
  it('should getOverdue returns tickets past SLA deadline and not resolved/closed', () => {
  ...
  it('should resolve not already-resolved stays resolved', () => {
    service.resolve('tk5'); // was already resolved
    expect(service.tickets.find(t => t.id === 'tk5')?.status).toBe('resolved');
  });
});
